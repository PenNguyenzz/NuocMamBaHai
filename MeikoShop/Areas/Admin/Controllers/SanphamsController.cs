...
namespace BaHai.Areas.Admin.Controllers
{
    public class SanphamsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.Machatlieu = new SelectList(db.Chatlieu, "Machatlieu", "Tenchatlieu");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Masp,Tensp,Giatien,Soluong,Mota,Thesim,Bonhotrong,Sanphammoi,Ram,Anhbia,Mahang,Machatlieu")] Sanpham sanpham)
        {
            ...
            ViewBag.Machatlieu = new SelectList(db.Chatlieu, "Machatlieu", "Tenchatlieu", sanpham.Machatlieu);
            return View(sanpham);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Masp,Tensp,Giatien,Soluong,Mota,Thesim,Bonhotrong,Sanphammoi,Ram,Anhbia,Mahang,Machatlieu")] Sanpham sanpham)
        {
            if (ModelState.IsValid)
            {
